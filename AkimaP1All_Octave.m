...
'#####   1'
f = @(x)x^3-1
[root,iter]=AkimaP1(f,0.6,1.5,tol)
f(root)
'#####   2'
f =@(x)x^2*(x^2/3+sqrt(2)*sin(x))-sqrt(3)/18  
[root,iter]=AkimaP1(f,0.1,1,tol)
f(root)
'#####   3'
f =@(x)11*x^11-1  
[root,iter]=AkimaP1(f,0.1,1,tol)
...
'#####   4'
f = @(x)x^3+1
[root,iter]=AkimaP1(f,-1.8,-0.5,tol)
f(root)
'#####   5'
f = @(x)x^3-2*x-5
[root,iter]=AkimaP1(f,2,3,tol)
f(root)
'#####   6'
f = @(x)2*x*exp(-5)+1-2*exp(-5*x)
[root,iter]=AkimaP1(f,0,1,tol)
f(root)
'#####   7'
